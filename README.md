...
J'ai crée une fentre modale qui présente `un tutoriel` et qui apparait une seule fois lorsqu'on clique sur les onglets. Vous devrez modifiez le `tutorialContent` pour la partie contenu du tutoriel 
