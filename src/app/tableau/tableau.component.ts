...
export class TableauComponent implements OnInit{
    ...
    tutorialContent:string = 'Bienvenue sur la page tableau. Les résultats de vos analyses sont répertoriés ici. Vous pouvez consulter les découvertes de chaque ingrédient en cliquant dessus.';
